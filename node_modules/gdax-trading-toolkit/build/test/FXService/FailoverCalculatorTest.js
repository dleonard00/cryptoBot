...
describe('FailoverCalculator', () => {
    ...
    before(() => {
        ...
        const calc1 = new SimpleRateCalculator_1.default(provider1, Logger_1.NullLogger);
        const calc2 = new SimpleRateCalculator_1.default(provider2, Logger_1.NullLogger);
